...
//			result.Buffer = new Graphics.VertexBuffer(game.GraphicsDevice, RenderingSystem3D.VertexDeclaration, vertices.Count, Graphics.BufferUsage.None);
//			result.Buffer.SetData<Vertex3D>(vertices.ToArray());
//			result.IndexBuffer = new Graphics.IndexBuffer(game.GraphicsDevice, Graphics.IndexElementSize.ThirtyTwoBits, indices.Count, Graphics.BufferUsage.None);

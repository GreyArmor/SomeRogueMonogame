...
namespace NamelessRogue.Engine.Utility
{
	...
	public class DebugDraw : IDisposable
	{
		...
		public void DrawWireShape(Vector3[] positionArray, ushort[] indexArray, XnaColor color)
		{
		...
		public void DrawWireGrid(Vector3 xAxis, Vector3 yAxis, Vector3 origin, int iXDivisions, int iYDivisions, XnaColor color)
		{
			Vector3 pos, step;
		...
		public void DrawWireFrustum(BoundingFrustum frustum, XnaColor color)
		{
		...
		public void DrawWireBox(BoundingBoxXna box, XnaColor color)
		{
		...
		public void DrawRing(Vector3 origin, Vector3 majorAxis, Vector3 minorAxis, XnaColor color)
		{
		...
		public void DrawWireSphere(BoundingSphere sphere, XnaColor color)
		{
		...
		public void DrawRay(Ray ray, XnaColor color, float length)
		{
			DrawLine(ray.Position, ray.Position + ray.Direction * length, color);
		}

		public void DrawLine(Vector3 v0, Vector3 v1, XnaColor color)
		{
			if (Reserve(2, 2))
			{
		...
		public void DrawWireTriangle(Vector3 v0, Vector3 v1, Vector3 v2, XnaColor color)
		{
			if (Reserve(3, 6))
			{

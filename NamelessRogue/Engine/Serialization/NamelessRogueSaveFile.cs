...
namespace NamelessRogue.Engine.Serialization.AutogeneratedSerializationClasses
{
		...
		//	StoragesDictionary.Add(typeof(BuffsStorage), BuffsStorageTable);
			...
			ComponentTypeToStorge.Add(typeof(NamelessRogue.Engine.Components.AI.NonPlayerCharacter.FollowPlayerAi), typeof(BasicAiStorage));
			...
			ComponentTypeToStorge.Add(typeof(NamelessRogue.Engine.Components.Stats.CharacterStats), typeof(StatsStorage));

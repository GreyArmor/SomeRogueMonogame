...
{
    [FlatBufferTable]
    public class BasicAiStorage : IStorage<NamelessRogue.Engine.Components.AI.NonPlayerCharacter.FollowPlayerAi>
    {
        ...
        public void FillFrom(NamelessRogue.Engine.Components.AI.NonPlayerCharacter.FollowPlayerAi component)
        {
        ...
        public void FillTo(NamelessRogue.Engine.Components.AI.NonPlayerCharacter.FollowPlayerAi component)
        {
        ...
        public static implicit operator NamelessRogue.Engine.Components.AI.NonPlayerCharacter.FollowPlayerAi (BasicAiStorage thisType)
        {
            if(thisType == null) { return null; }
            NamelessRogue.Engine.Components.AI.NonPlayerCharacter.FollowPlayerAi result = new NamelessRogue.Engine.Components.AI.NonPlayerCharacter.FollowPlayerAi();
            thisType.FillTo(result);
            return result;
        }

        public static implicit operator BasicAiStorage (NamelessRogue.Engine.Components.AI.NonPlayerCharacter.FollowPlayerAi  component)
        {

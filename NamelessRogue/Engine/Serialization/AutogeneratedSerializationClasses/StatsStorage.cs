...
{
    [FlatBufferTable]
    public class StatsStorage : IStorage<NamelessRogue.Engine.Components.Stats.CharacterStats>
    {
        ...
        public void FillFrom(NamelessRogue.Engine.Components.Stats.CharacterStats component)
        {
        ...
        public void FillTo(NamelessRogue.Engine.Components.Stats.CharacterStats component)
        {
        ...
        public static implicit operator NamelessRogue.Engine.Components.Stats.CharacterStats (StatsStorage thisType)
        {
            if(thisType == null) { return null; }
            NamelessRogue.Engine.Components.Stats.CharacterStats result = new NamelessRogue.Engine.Components.Stats.CharacterStats();
            thisType.FillTo(result);
            return result;
        }

        public static implicit operator StatsStorage (NamelessRogue.Engine.Components.Stats.CharacterStats  component)
        {

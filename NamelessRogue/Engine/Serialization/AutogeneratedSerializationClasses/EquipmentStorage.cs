...
{
    [FlatBufferTable]
    public class EquipmentStorage : IStorage<NamelessRogue.Engine.Components.ItemComponents.Equipment>
    {
        ...
        public static implicit operator NamelessRogue.Engine.Components.ItemComponents.Equipment (EquipmentStorage thisType)
        {
        ...
        public static implicit operator EquipmentStorage (NamelessRogue.Engine.Components.ItemComponents.Equipment  component)
        {
            if(component == null) { return null; }
            EquipmentStorage result = new EquipmentStorage();
